<?php
   ...
   if ($_SESSION["song"] == 6) 
   {
        echo "<script> var stateSong1 = true; </script>";
   }
   else if($_SESSION["song"] == 7)
   {
        echo "<script> var stateSong2 = true; </script>";
   }
   else if($_SESSION["song"] == 8)
   {
        echo "<script> var stateSong3 = true; </script>";
   }
   else if($_SESSION["song"] == 9)
   {
        echo "<script> var stateSong4 = true; </script>";
   }
   else if($_SESSION["song"] == 10)
   {
        echo "<script> var stateSong5 = true; </script>";
   }
            ...
            function sendTrack(number)
            {
                switch (number) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        var GetTrackId = "<?php echo $get_track_id5; ?>";
                        var GetTrackName = "<?php echo $get_track_name5; ?>";
                        var GetTrackAlbum = "<?php echo $get_track_album5; ?>";
                        var GetTrackArtist = "<?php echo $get_track_artist5; ?>";
                        var GetTrackGenre = "<?php echo $get_track_genre5; ?>";
                        var GetTrackMilliseconds = "<?php echo $get_track_milliseconds5; ?>";
                        var GetTrackBtyes = "<?php echo $get_track_btyes5; ?>";
                        var GetTrackUnitPrice = "<?php echo $get_track_unitPrice5; ?>";
